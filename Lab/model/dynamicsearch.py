...
class CompareConstant(object):
	...
	def setConstant(self, constant=None):
		if constant is None:
			return Lab.utils.menuInput(self.setConstant, [collections.namedtuple("instances",\
				["column_name", "data_type", "default"])(self.psql_type, self.psql_type, lambda: None)])
		else:
